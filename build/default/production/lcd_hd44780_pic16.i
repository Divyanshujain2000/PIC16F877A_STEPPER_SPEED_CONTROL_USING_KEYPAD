...
void LCDBusyLoop();
# 47 "lcd_hd44780_pic16.c" 2
# 1 "./myutils.h" 1
# 48 "lcd_hd44780_pic16.c" 2
# 1 "./custom_char.h" 1
# 15 "./custom_char.h"
...
# 49 "lcd_hd44780_pic16.c" 2
# 80 "lcd_hd44780_pic16.c"
...
_delay((unsigned long)((0.5)*(20000000/4000000.0)));

(RD3=1);



temp=(PORTD & (~(0X0F<<4)))|((hn<<4));
PORTD=temp;
